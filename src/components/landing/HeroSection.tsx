      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <button 
            ...
            className="btn-cta inline-flex items-center justify-center gap-2 text-sm md:text-base py-4 px-8 whitespace-nowrap"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full border-2 border-primary text-primary font-heading font-semibold hover:bg-primary/5 transition-colors text-sm md:text-base whitespace-nowrap"
          >
